...
export function SegmentProgressBar() {
  ...
  return (
    <div className="flex flex-col items-center justify-center my-4 select-none group">
      ...
      <div className="relative p-1 border border-[#38bdf8]/60 bg-[#09090b]/80 backdrop-blur-sm rounded-none shadow-[0_0_15px_rgba(56,189,248,0.15)] group-hover:border-[#34d399]/80 transition-colors">
        {/* Corner tech ticks */}
        ...
        <div className="flex gap-[3px] items-center px-1.5 py-1 bg-[#0c0c0f]">
          {Array.from({ length: totalSegments }).map((_, i) => {
            ...
            return (
              <div
                key={i}
                className={`w-2.5 sm:w-3.5 h-5 sm:h-6 transition-all duration-75 ${bgColor} ${
                  isActive ? glow : ''
      ...
      <div className="flex items-center justify-between w-full max-w-md mt-2 px-1 text-[11px] font-mono-hud text-[#a1a1aa]">
        <div className="flex items-center gap-2">
          ...
          <span className="text-[#34d399]">{GUI_PHRASES[phraseIndex]}</span>
        </div>
